...
const YEARONE = schools.management.departments[0].courses.yearOne;
const YEARTWO = schools.management.departments[0].courses.yearTwo;
    ...
    <>
      <section className="px-5 md:px-10 py-10">
        <div className="py-4 flex justify-between items-center">
          ...
          <a
            href="/schools/management/accounting#others"
